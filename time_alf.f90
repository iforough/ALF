    !gfortran Alf.f90 ALfx.f90 constant.f90 time_alf.f90 -O3 -march=native
    ...
    open(1452, file='time_analysis.txt')
    
    print*, 'cpu time for computation fnALF for uniform grid over theta in [0,89] : '
    print*
